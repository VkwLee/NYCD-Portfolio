window.onload= function() {
	...
	var myNode = document.querySelector('.o-pics__item-current');
	myNode.addEventListener("click",function(e){
		...
		//follow the current window
		myOverlay.style.top = pageYOffset + 'px';
		myOverlay.style.left = pageXOffset + 'px';
		...
		//wait untill image is loaded because if you don't it will think it doesn't have any width or height
